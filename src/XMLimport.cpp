...
void XMLimport::readHostPackage( Host * pT )
{
    ...
    pT->mTelnet.mUseUTF8 = ( attributes().value("mUseUTF8") == "yes" );
    if(pT->mTelnet.mUseUTF8 && pT->mTelnet.encoding != "UTF-8" ||
       !pT->mTelnet.mUseUTF8 && pT->mTelnet.encoding != "ISO-8859-1")
            pT->mTelnet.encodingChanged( pT->mTelnet.mUseUTF8 ? "UTF-8" : "ISO-8859-1" );
