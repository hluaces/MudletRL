...
-- Zoilder 09/04/2015: Cambiado el evento para que se ejecute al activarse el GMCP en el cliente, no al reconectar, pues en ese punto aún no lo habrá negociado con el mud.
--registerAnonymousEventHandler("sysConnectionEvent", "gmod.reenableModules")
registerAnonymousEventHandler("sysGMCPenabledEvent", "gmod.reenableModules")
