...
public:
   ...
   // Zoilder 29/03/2015: Función que permite escribir en miniconsolas aplicando formato de colores (Igual que en la main console)
   void                          printOnDisplay( Host * pHost, QString & name, std::string & text);
   // Zoilder 29/03/2015: Funciones que devuelven el número de columnas / filas de la consola indicada.
   int                           getColumns( Host * pHost, QString & name );
   int                           getRows( Host * pHost, QString & name );
