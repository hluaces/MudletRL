...
void TScript::callEventHandler( const TEvent & pE )
{
    ...
    {
        // Zoilder 04/04/2015: Si aún no se ha compilado el script, se compila.
        //                      Esto evita errores con el evento 'Resize', pues se empezará a llamar desde que se cree
        //                      la ventana, cuando aún no ha compilado los scripts.
        //                      Además compilará todos sus padres que no lo estén.
        compileAncestors();
        compile();
