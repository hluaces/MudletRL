...
public:
    ...
    // Zoilder 04/04/2015: Compila todos los padres de un nodo.
    void               compileAncestors();
...
// Zoilder 04/04/2015: Función que compila todos los padres del nodo.
template<class T>
void Tree<T>::compileAncestors()
{
    T *node = mpParent;
    while(node)
    {
