...
public:
    ...
    // Zoilder 31/03/2015: Función para obtener si debe realizar el eco de los comandos.
    bool              getCommandEcho();
    ...
    QString           encodeUTF8(std::string &);
    bool              mUseUTF8;
    // Zoilder 21/03/2015: Paso a public para que desde otros objetos pueda obtenerse el encoding actual.
    QString           encoding;
    // Zoilder 09/04/2015: Función para comprobar si ya está activo el GMCP en el host.
    bool              isGMCPEnable(){ return enableGMCP; }
    // Zoilder 05/06/2015: Función para enviar a la mudlib la configuración de GMCP (columnas, filas, encoding, etc.)
    void              resetGMCP(bool complete);
...
private:
    ...
    // Zoilder 31/03/2015: Control del eco de los comandos.
    bool              mCommandEcho;
