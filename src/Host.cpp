...
// Zoilder 03/06/2015: Por defecto activa esta opción, pues nuestro cliente es para tener nuestra GUI.
, mEnableGMCP( true )
, mFORCE_GA_OFF( false )
...
// Zoilder 03/06/2015: Por defecto inactiva esta opción, que en nuestro mud a veces se come saltos de línea y estropean las salidas de textos encolumnadas.
...
//        #endif
        ...
        for( int i=0; i<entries.size(); i++ )
        {
            ...
            // Zoilder 30/03/2015: Almacena el nombre del paquete instalado.
            //                     Se hace aquí pues el nombre del paquete puede haber variado y haber
            //                     cogido el nombre que va en el fichero config.lua.
            mServerGUI_Package_name = packageName;
    ...
    // Zoilder 28/03/2015: Se ejecuta el evento que indica que se ha instalado el paquete.
    //                     Así el propio paquete puede auto-inicializarse sin tener que reabrir la sesión.
    TEvent me;
    string nameEvent = string("sysInstallPackage") + packageName.toUtf8().data() + string("Event");
    me.mArgumentList.append( QString(nameEvent.c_str()) );
...
//     3=uninstall from a script
    ...
    // Zoilder 28/03/2015: Se ejecuta el evento que indica que se va a desinstalar el paquete.
    //                     Así el propio paquete puede eliminar lo que necesite sin tener que reabrir la sesión.
    TEvent me;
    string nameEvent = string("sysUninstallPackage") + packageName.toUtf8().data() + string("Event");
    me.mArgumentList.append( QString(nameEvent.c_str()) );
    me.mArgumentTypeList.append( ARGUMENT_TYPE_STRING );
    raiseEvent( me );
