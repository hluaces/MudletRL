...
public:
        ...
        // Zoilder 07/04/2015: Se inicia a NULL para así poder comprobar si se ha instanciado.
        QProgressDialog * mpProgressDialog = NULL;
        QNetworkReply * mpReply;

        // Zoilder 13/05/2015: Descompresión de mapa.
        QList<QString> descomprimeMapa(QString);
